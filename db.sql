...
CREATE TABLE IF NOT EXISTS `order` (
  ...
  `create_date` varchar(50) NOT NULL COMMENT '下单日期',
  `product_id` varchar(4096) NOT NULL COMMENT '产品ID',
  `product_name` varchar(4096) NOT NULL COMMENT '产品名',
  `status` int(50) NOT NULL COMMENT '订单状态：1-未处理、2-正在处理、3-已完成',
  `update_date` datetime NOT NULL COMMENT '最后处理时间',
  `accept` int(11) NOT NULL COMMENT '处理人',
  PRIMARY KEY (`id`)
